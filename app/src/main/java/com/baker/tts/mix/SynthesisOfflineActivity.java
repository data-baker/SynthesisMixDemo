...
public class SynthesisOfflineActivity extends BakerBaseActivity {
    ...
    private void initOfflineEngine() {
        ...
        //静静
        String jingJing_Chn = Util.AssetsFileToString(SynthesisOfflineActivity.this, "Jingjing/mix005007128_16k_jingjing_100k.tflite.x");
        String jingJing_Mgvocoder = Util.AssetsFileToString(SynthesisOfflineActivity.this, "Jingjing/mg16000128_jingjing.tflite.x");
        //娇娇
        String jiaoJiao_Chn = Util.AssetsFileToString(SynthesisOfflineActivity.this, "Jiaojiao/mix005007128_16k_DB-CN-F-06-jiaojiao-small_288k.tflite.x");
        String jiaoJiao_Mgvocoder = Util.AssetsFileToString(SynthesisOfflineActivity.this, "Jiaojiao/mg16000128_jiaojiao_tf.tflite.x");
        //阿科
        String ake_Chn = Util.AssetsFileToString(SynthesisOfflineActivity.this, "ake/mix005007128_16k_DB-CN-M-02-ake_240k_small.tflite.x");
        String ake_Mgvocoder = Util.AssetsFileToString(SynthesisOfflineActivity.this, "ake/mg16000128_m2_ake.tflite.x");
